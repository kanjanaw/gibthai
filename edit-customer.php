...
<div class="px-4">
    ...
    <div class="panel">
        <div class="d-flex justify-content-between">
            <h4>แก้ไขข้อมูลลูกค้า - มหาวิทยาลัยธรรมศาสตร์ (ศูนย์รังสิต)</h4>
        </div>
                ...
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row py-3">
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-or-style" value="12345" disabled/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-or-style" value="มหาวิทยาลัยธรรมศาสตร์ (ศูนย์รังสิต)"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-or-style" value="Thammasat University (Rangsit Campus)"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-or-style" value="025644440"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="" class="form-or-style" value="xxxxxxxxxxxx"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="" id="" class="form-or-style">
                                                ...
                                                <option value="" selected>30 วัน</option>
                    ...
                    <div class="tab-pane fade" id="pipettes" role="tabpanel">
                        <h6 class="p-2 mb-3 bg-e5e5e5 fw-bold">ข้อมูลเครื่องมือสอบเทียบของลูกค้า</h6>
                            <!-- table menu -->
                            <div class="row d-flex align-items-center mb-2 mt-3" id="datatable_length">
                                <div class="col-12 text-md-end ms-auto text-center">
                                    <a type="button" class="btn-black bg-blue border-blue mb-2" data-bs-toggle="modal" data-bs-target="#selectPipettesForm">เลือกเครื่องมือสอบเทียบ</a>
                                ...
                                <div class="col-md-4 text-md-end text-center ms-auto py-1 py-md-0 order-0 order-md-1">
                                    <div class="col-auto">
                                        <button type="button" class="btn-grey">นำออก Excel</button>
                                        <button type="button" class="btn-grey">พิมพ์รายงาน</button>
