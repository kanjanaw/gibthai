...
<body>
        ...
        <div class="wrapper d-flex align-items-stretch">
			...
			<div class="p-0 my-3">
                ...
                <li <?php if(in_array(@$pageName, ["gr-invoice", "gr-invoice-status", "gr-invoice-method"]))
                echo 'class="active"';
                ?>>
                ...
                <ul class="collapse list-unstyled" id="grInvoiceSubmenu">
                    <li <?php if(@$pageName=="gr-invoice") echo 'class="active"'; ?>>
                        <a href="gr-invoice.php" class="submenu-sidebar">ข้อมูลใบรับ - ส่งเครื่อง</a>
                    </li>
                ...
                <ul class="collapse list-unstyled submenu-sidebar" id="serviceSubmenu">
                    <li>
                        <a href="service.php">งานบริการสอบเทียบ</a>
                    </li>
                    <li>
                        <a href="service-status.php">สถานะงานบริการ</a>
                    </li>
                </ul>
                </li>
                <li>
