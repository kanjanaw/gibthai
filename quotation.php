    ...
    <div class="panel">
        <div class="d-flex justify-content-between">
            <h4>ข้อมูลใบเสนอราคา</h4>
             <!-- add new quotation -->
             <a class="btn-black bg-green-00 border-green-00 py-1 px-5" type="button" href="quotation-new-quotation-menu.php">เพิ่มใบเสนอราคาใหม่</a>
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="edit-quotation.php" class="btn my-0 py-0 hover-text-red"><i class="fa-regular fa-pen-to-square"></i> แก้ไข</a></td>
                                </tr>
                                <tr>
                                    <td>August 1, 2023</td>
                                    <td>SOyymm-xxxx</td>
