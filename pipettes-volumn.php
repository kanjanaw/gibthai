...
<div class="px-4">
    <div class="breadcrumb" style="--bs-breadcrumb-divider: '>';">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ขนาด</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="panel">
        ...
        <!-- pipettes volumn table -->
        <div class="table-responsive">
            <table class="table table-hover text-nowrap" id="pipettesTypeTable">
            <thead>
                <tr>
                <th scope="col" data-field="pipetttesManufacturer">ขนาดเครื่องมือสอบเทียบ</th>
                <th scope="col" data-field="">รุ่นเครื่องมือสอบเทียบ</th>
