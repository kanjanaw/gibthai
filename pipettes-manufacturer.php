...
<div class="container-inner">
    <div class="breadcrumb" style="--bs-breadcrumb-divider: '>';">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ยี่ห้อ</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="panel">
        <div class="d-flex justify-content-between">
            <h4>ยี่ห้อเครื่องมือสอบเทียบ</h4>
        </div>
        ...
        <!-- pipettes manufacturer table -->
        <div class="table-responsive">
            <table class="table table-hover" id="pipettesTypeTable">
            <thead>
                <tr>
                <th scope="col" data-field="pipetttesManufacturer">ยี่ห้อเครื่องมือสอบเทียบ</th>
        ...
        <!-- end: pipettes manufacturer table -->
