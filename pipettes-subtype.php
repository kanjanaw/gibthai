...
<div class="container-inner">
    <div class="breadcrumb" style="--bs-breadcrumb-divider: '>';">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ประเภทย่อยเครื่องมือ</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="panel">
        <div class="d-flex justify-content-between">
            <h4>ประเภทย่อยเครื่องมือสอบเทียบ</h4>
        </div>
        ...
        <div class="table-responsive">
            ...
            <thead>
                <tr>
                <th scope="col" data-field="pipetttesType">ประเภทย่อยเครื่องมือสอบเทียบ</th>
